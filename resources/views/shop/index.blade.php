    ...
    <div>
        <div class="container max-w-lg px-20 py-5 mx-auto text-left md:max-w-none bg-cover h-screen">
            <div class="flex justify-between">
                <h1 class="mb-1 text-4xl font-extrabold leading-none text-gray-900 lg:text-5xl xl:text-6xl sm:mb-3"><a href="#">Our <span class="w-full text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 lg:inline tails-selected-element">Shop</span> </a></h1>
                <a href="/" class="mt-10">
            ...
            <div class="flex justify-between mt-10">
                <div class="rounded-lg w-3/12 bg-gray-100 py-3 px-3">
                    ...
                    <p class="font-medium text-black mt-2 text-lg font-semibold">$45,555</p>
