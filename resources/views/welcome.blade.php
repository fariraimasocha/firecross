...
@section('content')
    <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center bg-cover h-screen" style="background-image: url('{{ asset('images/ssuv.png') }}')">
        <h1 class="text-5xl font-bold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl">
